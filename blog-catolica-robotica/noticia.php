           ...
           <div class="homepage-hero-module">
               <div class="video-container">
                   ...
                   <video autoplay loop class="fillWidth" muted>
                       <source src="img/manfred.mp4" type="video/mp4" />Your browser does not support the video tag. I suggest you upgrade your browser.</video>
    ...
    <section style="margin-top: -120px">
      <div class="container">
        <div id="news" class="span12" style="margin-top: 10px">
         ...
         <div class="media">
           <a  class="">
             <img height="42" width="42" src="<?= $n->noticia_foto ?>" class="media-object img-polaroid" />
           </a>
